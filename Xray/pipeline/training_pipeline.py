...
from Xray.components.model_pusher import ModelPusher               # Lec 6
...
class TrainPipeline:
    def __init__(self):
        ...
        self.model_pusher_config = ModelPusherConfig()                 # Lec 6
    ...
    def start_model_evaluation(
        self,
        model_trainer_artifact: ModelTrainerArtifact,             # 來自 Lec 4
        data_transformation_artifact: DataTransformationArtifact, # 來自 Lec 3
        ...
        try:
            model_evaluation = ModelEvaluation(
                ...
                model_evaluation_config=self.model_evaluation_config,      # class TrainPipeline 本身自帶
            )
